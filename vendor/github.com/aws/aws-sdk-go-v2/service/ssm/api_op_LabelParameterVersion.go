...
//
// * You can't attach the same label to
// different versions of the same parameter. For example, if version 1 has the
// label Production, then you can't attach Production to version 2.
//
// * You can move
// a label from one version of a parameter to another.
//
// * You can't create a label
